...
<body id="page-top">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">¿Deseas terminar tu sesion en Helpy?<br> 
                si es asi haga click el "Salir" de lo contrario en "Cancelar".</div>
    ...
    <script src="{{asset('js/demo/GraficoCircular.js')}}"></script>
</body>
